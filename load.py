...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.product_Details_Table = self.findChild(QTableWidget, "item_Details_tableWidget")
        ...
        self.delete_Customer_contact_primaryKey_LineEdit= self.findChild(QLineEdit, "delete_Customer_contact_primaryKey_LineEdit")
        ...
        self.updateItem_ProductId_PrimaryKey_LineEdit = self.findChild(QLineEdit, "updateItem_ProductId_PrimaryKey_LineEdit")
        ...
        self.delete_Item_ProductId_Search_btn = self.findChild(QPushButton, "DeleteItem_Search_btn")
        self.delete_Item_ProductId_Search_btn.clicked.connect(self.retrive_Delete_Product_Details)
    ...
    def retrive_Product_Details(self):
        ...
        try:
            ...
            if row == None:
                ...
                for row1 in row:
                    self.updateItem_ProductName_LineEdit.setText(str(row1[1]))
                    self.updateItem_Rate_LineEdit.setText(str(row1[2]))
                    self.updateItem_Description_LineEdit.setText(str(row1[3]))

        except mc.Error as e:
            self.updateItem_ProductId_PrimaryKey_LineEdit("Error in connection")

    def retrive_Delete_Product_Details(self):
    ...
    def delete_Product_Details(self):
        ...
        try:
            ...
            p_Name1=str(self.deleteItem_ProductName_LineEdit.text())
            p_Rate=str(self.deleteItem_Rate_LineEdit.text())
            p_Desc=str(self.deleteItem_Description_LineEdit.text())


            query1 = ("DELETE FROM product_table WHERE Pname = '%s'" % (p_Name1))
            query2 = ("DELETE FROM product_table WHERE Rate = '%s'" % (p_Rate))
            query3 = ("DELETE FROM product_table WHERE Description = '%s'" % (p_Desc))
    ...
    def show_Product_Details(self):
        ...
        try:
            ...
            for row_number, row_data in enumerate(result):
                self.product_Details_Table.insertRow(row_number)

                for column_number, data in enumerate(row_data):
                    self.product_Details_Table.setItem(row_number, column_number, QTableWidgetItem(str(data)))
